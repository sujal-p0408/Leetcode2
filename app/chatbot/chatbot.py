...
def chat(user):
    ...
    try:
        ...
        - No Off-Topic Discussions: Do not engage in discussions about general programming, software development, etc.
        - No External Links or Resources: Do not provide links to any websites or tutorials.
        - No Code Debugging: Only highlight the specific incorrect line, no explanations.
        - No Opinions or Speculations: Stick to factual DSA information.
        - No Promotional Content: Do not promote tools, libraries, or platforms.
